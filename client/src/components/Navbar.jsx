...
const Navbar = () => {
  ...
  return (
    <header className="px-2 md:px-4 w-full mt-3">
      <nav className="flex items-center justify-between px-6 py-1 md:py-2 shadow-sm max-w-5xl rounded-full mx-auto w-full bg-white/50 backdrop-blur-sm">
        ...
        <div
          id="menu"
          className={`max-md:fixed max-md:top-0 max-md:left-0 max-md:overflow-hidden items-center justify-center max-md:h-full ${
            isSidebarOpen ? "max-md:w-full" : "max-md:w-0"
          } transition-all duration-100 max-md:bg-white/50 max-md:backdrop-blur flex flex-col md:flex-row gap-8 text-gray-900 text-sm font-normal`}
        >
          <Link
            to="/"
